%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Micro Grid Energy Optimization: MPC run on Step Reference Input 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Ess_ub      =3e5;         % kWs    Max capacity of battery
Ess_lb      =0.7*Ess_ub;  % kWs    Min allowed ESS
...
% Initial Input
Uguess      = 0.7*UB;         %        Initial Guesses for one iteration
